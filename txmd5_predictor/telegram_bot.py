...
class TelegramReporter:
    ...
    def format_report(self, total_sessions: int, session_id: int, result: str, point: int, dices: list,
        ...
        msg = (
            ...
            f"━━━━━━━━━━━━━━━━━━━\n"
            f"Tổng số phiên đã phân tích: `{total_sessions}`\n"
            ...
            f"Thuật toán tốt nhất hiện tại: `{best_algo}`\n"
            f"Độ chính xác (Logic %): `{accuracy*100:.2f}%`\n\n"
